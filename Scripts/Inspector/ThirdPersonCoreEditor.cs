...
public class ThirdPersonCoreEditor : InspectorBaseGUI
{
    ...
    protected override void OnEnable()
    {
        ...
        m_GroundCheckDistance = serializedObject.FindProperty("m_GroundCheckSphereRadius");
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (GUILayout.Button("System Settings", (selection == Selection.Controller) ? active : normal, GUILayout.Height(25)))
