...
namespace Ace
{
    ...
    [SaveDuringPlay]
    public class FramingTransposer : ACEComponentBase
    {
        /// <summary>
        ...
        public override ACECore.Stage Stage { get { return ACECore.Stage.Body; } }
        ...
        public override void MutateCameraState(ref CameraState curState, float deltaTime)
        {
            ...
            IACETargetGroup group = AbstractFollowTargetGroup;
        ...
        Vector3 ComputeGroupBounds(IACETargetGroup group, ref CameraState curState)
        {
        ...
        static Bounds GetScreenSpaceGroupBoundingBox(
            IACETargetGroup group, ref Vector3 pos, Quaternion orientation)
        {
            ...
            if (zRange.x > 0)
            {
                angles = Vector2.Max(maxAngles, VectorExtensions.Abs(minAngles));
