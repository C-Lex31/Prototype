    ...
    public class OrbitalTransposer : Transposer
    {
        ...
        internal UpdateHeadingDelegate HeadingUpdater
            = (OrbitalTransposer orbital, float deltaTime, Vector3 up) => {
                    return orbital.UpdateHeading(
                        ...
                        ACECore.Instance.IsLive(orbital.VirtualCamera));
                };
            ...
            ref VirtualCamBase.TransitionParams transitionParams)
        {
            ...
            if (fromCam != null //&& fromCam.Follow == FollowTarget
                && m_BindingMode != Transposer.BindingMode.SimpleFollowWithWorldUp
            ...
            if (IsValid)
            {
                ...
                if (deltaTime >= 0 && VirtualCamera.PreviousStateIsValid)
                {
                    ...
                    if (dir0.sqrMagnitude > 0.01f && dir1.sqrMagnitude > 0.01f)
                        curState.PositionDampingBypass = VectorExtensions.SafeFromToRotation(
        ...
        private float GetTargetHeading(float currentHeading, Quaternion targetOrientation)
        {
            ...
            if (!velocity.AlmostZero())
                return VectorExtensions.SignedAngle(
