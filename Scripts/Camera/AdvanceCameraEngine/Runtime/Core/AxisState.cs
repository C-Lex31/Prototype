    ...
    public struct AxisState
    {
        ...
        public bool Update(float deltaTime)
        {
            ...
            if (ACECore.UniformDeltaTimeOverride >= 0)
                deltaTime = ACECore.UniformDeltaTimeOverride; 
            ...
            {
                try { m_InputAxisValue = ACECore.GetInputAxis(m_InputAxisName); }
        ...
        public struct Recentering
        {
            ...
            {
                mLastAxisInputTime = ACECore.CurrentTime;
                mRecenteringVelocity = 0;
            }
            ...
            public void DoRecentering(ref AxisState axis, float deltaTime, float recenterTarget)
            {
                ...
                if (ACECore.CurrentTime < (mLastAxisInputTime + m_WaitTime))
                    return;
