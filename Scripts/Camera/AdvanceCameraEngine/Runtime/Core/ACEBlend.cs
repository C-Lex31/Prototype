...
namespace Ace
{
    ...
    public class ACEBlend
    {
        ...
        public ACEBlend(
            ICamera a, ICamera b, AnimationCurve curve, float duration, float t)
        {
            CamA = a;
            CamB = b;
            BlendCurve = curve;
    ...
    /// </summary>
    internal class StaticPointVirtualCamera : ICamera
    {
        ...
        public ICamera ParentCamera { get { return null; } }
        public bool IsLiveChild(ICamera vcam, bool dominantChildOnly = false) { return false; }
        public void UpdateCameraState(Vector3 worldUp, float deltaTime) {}
        public void InternalUpdateCameraState(Vector3 worldUp, float deltaTime) {}
        public void OnTransitionFromCamera(ICamera fromCam, Vector3 worldUp, float deltaTime) {}
    ...
    /// </summary>
    internal class BlendSourceVirtualCamera : ICamera
    {
        public BlendSourceVirtualCamera(ACEBlend blend) { Blend = blend; }
        public ACEBlend Blend { get; set; }
        ...
        public ICamera ParentCamera { get { return null; } }
        public bool IsLiveChild(ICamera vcam, bool dominantChildOnly = false)
