...
namespace Ace
{
    ...
    public abstract class ACEComponentBase : MonoBehaviour
    {
        /// <summary>Useful constant for very small floats</summary>
        protected const float Epsilon = Utility.VectorExtensions.Epsilon;

        /// <summary>Get the associated VirtualCamBase</summary>
        public VirtualCamBase VirtualCamera
        {
            get
            {
                if (m_vcamOwner == null)
                    m_vcamOwner = GetComponent<VirtualCamBase>();
                if (m_vcamOwner == null && transform.parent != null)
                    m_vcamOwner = transform.parent.GetComponent<VirtualCamBase>();
                return m_vcamOwner;
            }
        }
        VirtualCamBase m_vcamOwner;
        ...
        public Transform FollowTarget
        {
            get
            {
                VirtualCamBase vcam = VirtualCamera;
        ...
        private VirtualCamBase mCachedFollowTargetVcam;
        private IACETargetGroup mCachedFollowTargetGroup;
        ...
        void UpdateFollowTargetCache()
        {
            ...
            {
                mCachedFollowTargetVcam = mCachedFollowTarget.GetComponent<VirtualCamBase>();
                mCachedFollowTargetGroup = mCachedFollowTarget.GetComponent<IACETargetGroup>();
            }
        }

        /// <summary>Get Follow target as ICinemachineTargetGroup, or null if target is not a group</summary>
        public IACETargetGroup AbstractFollowTargetGroup
        {
            get
            {
        ...
        public ACETargetGroup FollowTargetGroup
        {
            get { return AbstractFollowTargetGroup as ACETargetGroup; }
        }
        ...
        public Quaternion FollowTargetRotation
        {
            get
            {
                ...
                if (target != mCachedFollowTarget)
                {
                    ...
                    if (target != null)
                        mCachedFollowTargetVcam = target.GetComponent<VirtualCamBase>();
                }
                if (mCachedFollowTargetVcam != null)
        ...
        private IACETargetGroup mCachedLookAtTargetGroup;
        ...
        void UpdateLookAtTargetCache()
        {
            ...
            {
                mCachedLookAtTargetVcam = mCachedLookAtTarget.GetComponent<VirtualCamBase>();
                mCachedLookAtTargetGroup = mCachedLookAtTarget.GetComponent<IACETargetGroup>();
            }
        }

        /// <summary>Get LookAt target as ICinemachineTargetGroup, or null if target is not a group</summary>
        public IACETargetGroup AbstractLookAtTargetGroup
        {
            get
            {
        ...
        public ACETargetGroup LookAtTargetGroup
        {
            get { return AbstractLookAtTargetGroup as ACETargetGroup; }
        }
        ...
        public abstract ACECore.Stage Stage { get; }
        ...
        public virtual bool OnTransitionFromCamera(
            ...
            ref VirtualCamBase.TransitionParams transitionParams)
        { return false; }
