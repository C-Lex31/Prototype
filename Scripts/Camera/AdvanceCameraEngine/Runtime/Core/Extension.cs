...
namespace Ace
{
    ...
    public abstract class Extension : MonoBehaviour
    {
        ...
        public virtual void PrePipelineMutateCameraStateCallback(
            VirtualCamBase vcam, ref CameraState curState, float deltaTime) {}
        ...
        public void InvokePostPipelineStageCallback(
            VirtualCamBase vcam,
            ACECore.Stage stage, ref CameraState state, float deltaTime)
        {
        ...
        public virtual bool OnTransitionFromCamera(
            ICamera fromCam, Vector3 worldUp, float deltaTime) { return false; }
        ...
        protected T GetExtraState<T>(ICamera vcam) where T : class, new()
        {
            if (mExtraState == null)
                mExtraState = new Dictionary<ICamera, System.Object>();
        ...
        private Dictionary<ICamera, System.Object> mExtraState;
    }
}
