...
#endif
    [ExcludeFromPreset]
    [AddComponentMenu("Ace/Ace State-Driven Camera")]
    [HelpURL(Documentation.BaseURL + "manual/CinemachineStateDrivenCamera.html")]
    public class ACEStateDrivenCamera : VirtualCamBase
    {
        ...
        public VirtualCamBase[] m_ChildCameras = null;
        ...
        public struct Instruction
        {
            ...
            public VirtualCamBase m_VirtualCamera;
        ...
        public ICamera LiveChild { set; get; }
        ...
        ICamera TransitioningFrom { get; set; }
        ...
        {
            UpdateListOfChildren();
            VirtualCamBase best = ChooseCurrentCamera();
            ...
            if (previousCam != LiveChild && LiveChild != null)
            {
                ...
                ACECore.Instance.GenerateCameraActivationEvent(LiveChild, previousCam);
                ...
                if (previousCam != null)
                {
                    ...
                    if (mActiveBlend == null || !mActiveBlend.Uses(previousCam))
                        ACECore.Instance.GenerateCameraCutEvent(LiveChild);
                }
            }
        ...
        public VirtualCamBase[] ChildCameras { get { UpdateListOfChildren(); return m_ChildCameras; }}
        ...
        private ACEBlend mActiveBlend = null;
        ...
        void UpdateListOfChildren()
        {
            if (m_ChildCameras != null && mInstructionDictionary != null && mStateParentLookup != null)
                return;
            List<VirtualCamBase> list = new List<VirtualCamBase>();
            VirtualCamBase[] kids = GetComponentsInChildren<VirtualCamBase>(true);
            foreach (VirtualCamBase k in kids)
        ...
        private VirtualCamBase ChooseCurrentCamera()
        {
            ...
            VirtualCamBase defaultCam = m_ChildCameras[0];
