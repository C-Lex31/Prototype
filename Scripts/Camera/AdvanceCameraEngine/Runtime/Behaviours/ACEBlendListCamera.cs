...
#endif
    [ExcludeFromPreset]
    [AddComponentMenu("Cinemachine/AceBlendListCamera")]
    [HelpURL(Documentation.BaseURL + "manual/CinemachineBlendListCamera.html")]
    public class ACEBlendListCamera : VirtualCamBase
    {
        ...
        public VirtualCamBase[] m_ChildCameras;
            ...
            ICamera fromCam, Vector3 worldUp, float deltaTime)
        {
            ...
            mActivationTime = ACECore.CurrentTime;
        ...
        /// <summary>Called by ACECore at designated update time
        ...
        public override void InternalUpdateCameraState(Vector3 worldUp, float deltaTime)
        {
            ...
            InvokePostPipelineStageCallback(
                this, ACECore.Stage.Finalize, ref m_State, deltaTime);
