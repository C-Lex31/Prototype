...
#endif
    [ExcludeFromPreset]
    [AddComponentMenu("Ace/Ace Virtual Camera")]
    [HelpURL(Documentation.BaseURL + "manual/CinemachineVirtualCamera.html")]
    public class ACEVirtualCamera : VirtualCamBase
    {
        ...
        /// Called by ACECore at the appropriate Update time
        ...
        override protected void OnEnable()
        {
            ...
            {
                if (Follow != null && GetCinemachineComponent(ACECore.Stage.Body) == null)
                    AddCinemachineComponent<HardLockOnTarget>();
                if (LookAt != null && GetCinemachineComponent(ACECore.Stage.Aim) == null)
                    AddCinemachineComponent<HardLookAt>();
            }
        }
        ...
        protected override void OnDestroy()
        {
            ...
            foreach (Transform child in transform)
                if (child.GetComponent<ACEPipeline>() != null)
        ...
        private Transform CreatePipeline(ACEVirtualCamera copyFrom)
        {
            ACEComponentBase[] components = null;
            if (copyFrom != null)
            {
        ...
        public ACEComponentBase[] GetComponentPipeline() { UpdateComponentPipeline(); return m_ComponentPipeline; }
        ...
        public ACEComponentBase GetCinemachineComponent(ACECore.Stage stage)
        {
            ACEComponentBase[] components = GetComponentPipeline();
            if (components != null)
        ...
        public T GetCinemachineComponent<T>() where T : ACEComponentBase
        {
            ACEComponentBase[] components = GetComponentPipeline();
            if (components != null)
                foreach (var c in components)
        ...
        public T AddCinemachineComponent<T>() where T : ACEComponentBase
        {
            ...
            if (component != null && components != null)
            {
                ...
                ACECore.Stage stage = component.Stage;
        ...
        public void DestroyCinemachineComponent<T>() where T : ACEComponentBase
        {
            ACEComponentBase[] components = GetComponentPipeline();
            if (components != null)
            {
        ...
        ACEComponentBase[] m_ComponentPipeline = null;
        ...
        void UpdateComponentPipeline()
        {
            ...
            if (m_ComponentOwner != null && m_ComponentOwner.parent != transform)
            {
                ...
                {
                    ACEVirtualCamera copyFrom = (m_ComponentOwner.parent != null)
                        ? m_ComponentOwner.parent.gameObject.GetComponent<ACEVirtualCamera>() : null;
                    DestroyPipeline();
            ...
            m_ComponentOwner = null;
            List<ACEComponentBase> list = new List<ACEComponentBase>();
            foreach (Transform child in transform)
            {
                if (child.GetComponent<ACEPipeline>() != null)
                {
                    m_ComponentOwner = child;
                    ACEComponentBase[] components = child.GetComponents<ACEComponentBase>();
                    foreach (ACEComponentBase c in components)
                        if (c.enabled)
                            list.Add(c);
                }
            }
        ...
        private VirtualCamBase mCachedLookAtTargetVcam;
        private CameraState CalculateNewState(Vector3 worldUp, float deltaTime)
        {
            ...
            if (lookAtTarget != mCachedLookAtTarget)
            {
                ...
                if (lookAtTarget != null)
                    mCachedLookAtTargetVcam = lookAtTarget.GetComponent<VirtualCamBase>();
            }
            if (lookAtTarget != null)
            {
            ...
            if (m_ComponentPipeline == null)
            {
                ...
                for (var stage = ACECore.Stage.Body; stage <= ACECore.Stage.Finalize; ++stage)
            ...
            else
            {
                ...
                ACEComponentBase postAimBody = null;
                for (var stage = ACECore.Stage.Body; stage <= ACECore.Stage.Finalize; ++stage)
                {
                    ...
                    {
                        ++componentIndex;
                        if (stage == ACECore.Stage.Body && c.BodyAppliesAfterAim)
                        {
                            postAimBody = c;
                    ...
                    if (stage == ACECore.Stage.Aim)
                    {
                        ...
                        if (postAimBody != null)
                        {
                            ...
                            InvokePostPipelineStageCallback(this, ACECore.Stage.Body, ref state, deltaTime);
                        }
                    }
                }
            }
