...
{
    [CustomEditor(typeof(ACEBrain))]
    [CanEditMultipleObjects]
    public sealed class ACEBrainEditor : BaseEditor<ACEBrain>
    {
        EmbeddeAssetEditor<ACEBlenderConfig> m_BlendsEditor;
        ...
        {
            m_BlendsEditor = new EmbeddeAssetEditor<ACEBlenderConfig>(FieldPath(x => x.m_CustomBlends), this);
            m_BlendsEditor.OnChanged = (ACEBlenderConfig b) => { InspectorUtility.RepaintGameView(); };
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUI.enabled = false;
            ICamera vcam = Target.ActiveVirtualCamera;
        ...
        [DrawGizmo(GizmoType.Selected | GizmoType.NonSelected, typeof(ACEBrain))]
        private static void DrawBrainGizmos(ACEBrain brain, GizmoType drawType)
        {
        ...
        internal static void DrawCameraFrustumGizmo(
            ACEBrain brain, LensSettings lens,
        ...
        [DrawGizmo(GizmoType.Active | GizmoType.InSelectionHierarchy | GizmoType.Pickable, typeof(VirtualCamBase))]
        public static void DrawVirtualCameraBaseGizmos(VirtualCamBase vcam, GizmoType selectionType)
        {
            ...
            DrawCameraFrustumGizmo(
                ACECore.Instance.FindPotentialTargetBrain(vcam),
                state.Lens,
                Matrix4x4.TRS(
                    state.FinalPosition,
                    UnityQuaternionExtensions.Normalized(state.FinalOrientation), Vector3.one),
                ACECore.Instance.IsLive(vcam)
                    ? ACESettings.ACECoreSettings.ActiveGizmoColour
                    : ACESettings.ACECoreSettings.InactiveGizmoColour);
        }

//#if UNITY_2019_1_OR_NEWER
        static string kGizmoFileName = "Assets/Scripts/Camera/AdvanceCameraEngine/Gizmos/cm_logo.png";
/*#else
        static string kGizmoFileName = "Camera/AdvanceCameraSystem/Editor/Resources/cm_logo_sm.png";
        [InitializeOnLoad]
