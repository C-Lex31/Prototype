...
{
    [CustomEditor(typeof(ACEBlenderConfig))]
    internal sealed class ACEBlenderConfigEditor : BaseEditor<ACEBlenderConfig>
    {
        ...
        public delegate VirtualCamBase[] GetAllVirtualCamerasDelegate();
        ...
        private void UpdateCameraCandidates()
        {
            ...
            else
            {
                ...
                candidates = Resources.FindObjectsOfTypeAll(
                        typeof(VirtualCamBase)) as VirtualCamBase[];
            ...
            vcams.Add(ACEBlenderConfig.kBlendFromAnyCameraLabel);
            foreach (VirtualCamBase c in candidates)
        ...
        void SetupBlendList()
        {
            ...
            ACEBlenderConfig.CustomBlend def = new ACEBlenderConfig.CustomBlend();
