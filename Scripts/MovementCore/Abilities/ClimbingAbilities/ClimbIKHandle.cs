...
public class ClimbIKHandle : Modifier
{
    // -------------------------------------------- MASTER CONTROL --------------------------------------------- //
    ...
    /// <summary>
    /// It must be called by climbing component in every frame to calculate hand position (Think of this method like an Update)
    /// </summary>
